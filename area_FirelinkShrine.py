...
def firelink_shrine():
    ...
    TextSouls.adventurer.name = input()
    print("Ahh, your name is "+ TextSouls.adventurer.name)
    time.sleep(2)
...
def concerned_knight_dialog():
    ...
    if answer.lower() == "yes":
        ...
        TextSouls.adventurer.gold = TextSouls.adventurer.gold -20
        time.sleep(2)
...
def havel_fight():
    ...
    if answer.lower() == "block":
        ...
        time.sleep(2)
        chance_block = random.randint(1,20) + TextSouls.adventurer.strength
        if chance_block >= 30:
            time.sleep(2)
        ...
        time.sleep(2)
        chance_dodge = random.randint(1,20) + TextSouls.adventurer.dexterity
        if chance_dodge >= 30:
            time.sleep(2)
